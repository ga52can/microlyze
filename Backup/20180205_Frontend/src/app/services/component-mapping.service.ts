...
export class ComponentMappingService extends ServiceBase {
  ...
  public getComponentMappings(): Observable<Array<ComponentMapping>> {
    return this.http.get<Response>(this.apiUrl + 'component-mapping', {headers: this.headers}).map<Response, Array<ComponentMapping>>(response => {
  ...
  public getUnmapped(): Observable<Array<UnmappedTrace>> {
    return this.http.get<Response>(this.apiUrl + 'component-mapping/unmapped', {headers: this.headers}).map<Response, Array<UnmappedTrace>>(response => {
  ...
  public deleteMapping(componentMapping: ComponentMapping): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      this.http.delete<Response>(this.apiUrl + 'component-mapping/' + componentMapping.id, {headers: this.headers})
        .subscribe(Response => {
          resolve();
        });
    })
  ...
  public setMapping(component: Component, regex: string, httpMethods: number): Promise<void> {
    return new Promise<void>((resolve, reject) => {
      this.http.post<Response>(this.apiUrl + 'component-mapping', { httpPathRegex: regex, httpMethods: httpMethods, component: component.id },{headers: this.headers})
        .subscribe(Response => {
          resolve();
        });
    })
