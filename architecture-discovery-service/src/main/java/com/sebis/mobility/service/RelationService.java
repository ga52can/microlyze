...
import com.sebis.mobility.jpa.repository.RelationRepository;
...
public class RelationService {
    ...
    public void setInstanceRevisionRelations(Revision instanceRevision, Revision serviceRevision, Revision hardwareRevision) {
        ...
        Assert.isTrue(serviceRevision.getComponent() instanceof com.sebis.mobility.jpa.domain.component.Service);
